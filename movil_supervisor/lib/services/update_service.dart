...
class UpdateService {
  ...
  Future<void> checkForUpdates(
          ...
          content: Row(
            children: [
              SizedBox(
                width: 16,
                height: 16,
                child: CircularProgressIndicator(strokeWidth: 2, color: FincaTheme.primaryGreen),
              ),
              SizedBox(width: 12),
              Text('Verificando actualizaciones de CowIA Campo...'),
            ],
          ),
    ...
    try {
      ...
      if (remote != null) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
            content: const Text(
              'No se pudo conectar al servidor de actualizaciones. Revisa tu conexión a Internet.',
      ...
      _isChecking = false;
      debugPrint('⚠️ [UpdateService-Campo] Excepción en checkForUpdates: $e');
    }
  }
    ...
    try {
      OtaUpdate()
          .execute(
            ...
            destinationFilename: 'CowIA-Campo-Update.apk',
          )
          .listen(
        (OtaEvent event) {
          if (!mounted) return;
          ...
          switch (event.status) {
            case OtaStatus.DOWNLOADING:
              ...
              setState(() {
                ...
                _statusMessage = 'Descargando actualización: ${parsed.toInt()}%';
              });
              break;
            ...
            default:
              setState(() {
                _isDownloading = false;
                _errorMessage = 'Error en la descarga (${event.status.name}). Revisa tu conexión.';
              });
              break;
          }
        },
    ...
    return PopScope(
      ...
      child: AlertDialog(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: const BorderSide(color: FincaTheme.borderCard, width: 1.5),
        ),
          ...
          children: [
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: FincaTheme.primaryGreen.withValues(alpha: 0.35),
                      width: 1.5,
                    ),
                  ),
                  child: const Center(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: FincaTheme.accentGreenLight.withValues(alpha: 0.15),
                          borderRadius: BorderRadius.circular(6),
                          border: Border.all(
                            color: FincaTheme.accentGreenLight.withValues(alpha: 0.3),
                            width: 1,
                          ),
                        ),
                        child: Text(
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  const Icon(Icons.arrow_forward_rounded, size: 14, color: FincaTheme.textMuted),
                  Text(
            ...
            if (_isDownloading) ...[
              LinearProgressIndicator(
                ...
                valueColor: const AlwaysStoppedAnimation<Color>(FincaTheme.primaryGreen),
            ...
            if (_errorMessage != null) ...[
              Container(
                ...
                decoration: BoxDecoration(
                  color: FincaTheme.errorCrimson.withValues(alpha: 0.12),
                  borderRadius: BorderRadius.circular(8),
                  border: Border.all(color: FincaTheme.errorCrimson.withValues(alpha: 0.3)),
                ),
                child: Row(
                  children: [
