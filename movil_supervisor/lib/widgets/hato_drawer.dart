...
class _HatoDrawerState extends State<HatoDrawer> {
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Botón Trazar Nuevo Potrero (Controlado por permiso técnico)
                  SizedBox(
                    width: double.infinity,
                    child: ElevatedButton.icon(
                      style: ElevatedButton.styleFrom(
                        backgroundColor: agroProvider.permiteCrearPotreros
                            ? const Color(0xFF10B981)
                            : const Color(0xFF334155),
                        foregroundColor: agroProvider.permiteCrearPotreros
                            ? Colors.black
                      ...
                      icon: Icon(
                        agroProvider.permiteCrearPotreros
                            ? Icons.add_circle_outline_rounded
                            : Icons.lock_outline_rounded,
                        size: 18,
                        color: agroProvider.permiteCrearPotreros ? Colors.black : Colors.grey.shade400,
                      ),
                      label: Text(
                        agroProvider.permiteCrearPotreros
                            ? 'Trazar Nuevo Potrero'
                            : 'Trazar Potrero (Sin Permiso)',
                        style: const TextStyle(fontWeight: FontWeight.w800, fontSize: 13),
                      ),
                      onPressed: drawingProvider.isDrawing || agroProvider.hatos.isEmpty
                          ? null
                          : () {
                              if (!agroProvider.permiteCrearPotreros) {
                                _mostrarDialogoPermisoRequerido(context);
                                return;
                              }
                              Navigator.of(context).pop();
                              final targetHato = agroProvider.selectedHato ?? agroProvider.hatos.first;
                              drawingProvider.startDrawingPotrero(targetHato.id, agroProvider.hatos);
                            },
                    ),
                  ),
                ],
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: 'Buscar potrero o predio...',
  ...
  void _mostrarDialogoPermisoRequerido(BuildContext context) {
    showDialog(
      context: context,
      builder: (_) => AlertDialog(
        backgroundColor: const Color(0xFF0F172A),
        title: const Row(
          children: [
            Icon(Icons.lock_person_rounded, color: Color(0xFFF59E0B), size: 22),
            SizedBox(width: 10),
            Expanded(
              child: Text(
                'Permiso Requerido',
        ...
        content: const Text(
          'La creación y subdivisión de potreros está bloqueada para esta hacienda.\n\nPara habilitar el diseño de pasturas, solicita la activación de la bandera "Permite Crear Potreros" a tu asesor técnico o administrador CowIA.',
